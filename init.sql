...
('山田太郎', '営業部長', 'yamada@example.com'),
('鈴木花子', '営業担当', 'suzuki@example.com'),
('佐藤健太', 'マーケティング担当', 'sato@example.com');

-- 顧客テーブルにダミーデータを挿入
INSERT INTO customers (name, address, tel, email) VALUES
('株式会社A', '東京都渋谷区', '03-1234-5678', 'info@company-a.com'),
('株式会社B', '大阪府大阪市', '06-9876-5432', 'info@company-b.com'),
('株式会社C', '福岡県福岡市', '092-111-2222', 'info@company-c.com');
...
('2025-01-01', 1, 1, 1, 5, '受注済み'),
('2025-01-02', 2, 2, 2, 10, '発送済み'),
('2025-02-03', 1, 2, 2, 8, 'キャンセル'),
('2025-02-03', 2, 3, 3, 8, '発送済み'),
('2025-02-03', 3, 2, 3, 8, 'キャンセル'),
('2025-03-15', 1, 1, 2, 3, '受注済み'),
('2025-03-16', 2, 2, 2, 10, '発送済み');